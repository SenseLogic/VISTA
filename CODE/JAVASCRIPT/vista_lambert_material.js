...
class VISTA_LAMBERT_MATERIAL extends VISTA_MATERIAL
{
        ...
        )
    {
        ...
        this.SetVertexShaderCode(
            ...
            attribute vec3 VertexNormalAttribute;
            ...
            void main()
            {
                vec4 vertex_position_vector = ModelViewMatrix * vec4( VertexPositionAttribute, 1.0 );
                VertexPositionVectorVarying = vec3( vertex_position_vector ) / vertex_position_vector.w;
                VertexNormalVectorVarying = vec3( NormalMatrix * vec4( VertexNormalAttribute, 0.0 ) );
                gl_Position = ProjectionMatrix * vertex_position_vector;
